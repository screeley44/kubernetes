...
func TestSync(t *testing.T) {
	...
	tests := []controllerTest{
		...
		{
			// failed syncVolume do not bind when volumeModes do not match
			// for example claim requests file but volume is block
			"14-6-1 - do not bind when volumeModes do not match",
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-6-1", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-6-1", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-6-1", "uid14-6-1", "10Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-6-1", "uid14-6-1", "10Gi", "", v1.ClaimPending, nil)),
			[]string{"Normal FailedBinding"},
			noerrors, testSyncClaim,
		},
		{
			// failed syncVolume do not bind when volumeModes do not match
			// for example claim requests block but volume is unspecified (filesystem by default)
			"14-6-2 - do not bind when volumeModes do not match, unspecified volume and requested block for claim",
			withVolumeVolumeMode(nil, newVolumeArray("volume14-6-2", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withVolumeVolumeMode(nil, newVolumeArray("volume14-6-2", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-6-2", "uid14-6-2", "10Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-6-2", "uid14-6-2", "10Gi", "", v1.ClaimPending, nil)),
			[]string{"Normal FailedBinding"},
			noerrors, testSyncClaim,
		},
		{
			...
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-7", "10Gi", "uid14-7", "claim14-7", v1.VolumeBound, v1.PersistentVolumeReclaimRetain, classEmpty, annBoundByController)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-7", "uid14-7", "10Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-7", "uid14-7", "10Gi", "volume14-7", v1.ClaimBound, nil, annBindCompleted)),
			noevents, noerrors, testSyncClaim,
		},
		{
		...
		},
		{
			...
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-9", "uid14-9", "10Gi", "volume14-9", v1.ClaimBound, nil, annBoundByController, annBindCompleted)),
			noevents, noerrors, testSyncClaim,
		},
		{
			...
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-10", "10Gi", "uid14-10", "claim14-10", v1.VolumeBound, v1.PersistentVolumeReclaimRetain, classEmpty, annBoundByController)),
		...
		},
		{
			...
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-11", "uid14-11", "10Gi", "volume14-11", v1.ClaimBound, nil, annBoundByController, annBindCompleted)),
			noevents, noerrors, testSyncClaim,
		},
		{
			...
			withVolumeVolumeMode(&modeFile, newVolumeArray("volume14-12", "10Gi", "uid14-12", "claim14-12", v1.VolumeBound, v1.PersistentVolumeReclaimRetain, classEmpty, annBoundByController)),
